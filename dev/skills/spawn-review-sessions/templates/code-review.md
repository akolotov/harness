You are picking up a single comment raised during a review of the pull request
associated with the current branch (its local and remote HEAD match). Read the PR
description first, before anything else.
